...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        List<int[][]> lDown = new ArrayList<>();
        lDown.add(ShapeMatrix.FIRE_DOWN_1);
        lDown.add(ShapeMatrix.FIRE_DOWN_2);
        lDown.add(ShapeMatrix.FIRE_DOWN_3);
        downFire = new RocketFire(lDown);
        List<int[][]> lLeft = new ArrayList<>();
        lLeft.add(ShapeMatrix.FIRE_SIDE_1);
        lLeft.add(ShapeMatrix.FIRE_SIDE_2);
        leftFire = new RocketFire(lLeft);
        List<int[][]> lRight = new ArrayList<>();
        lRight.add(ShapeMatrix.FIRE_SIDE_1);
        lRight.add(ShapeMatrix.FIRE_SIDE_2);
        rightFire = new RocketFire(lRight);
    }
